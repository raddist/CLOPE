...
TxtStreamer::TxtStreamer(char* i_fileName, char* i_ruleName)
...
TxtStreamer::~TxtStreamer() {};

bool TxtStreamer::OpenStream()
{
...
///////////////////////////////////////////////////////////////////////////////////////////
bool TxtStreamer::ReadTransaction(CTransaction& o_transaction)
{
...
///////////////////////////////////////////////////////////////////////////////////////////
void TxtStreamer::AppendCINToTransaction(int i_CIN)
{
	m_out_cin << i_CIN << "\n";
}

///////////////////////////////////////////////////////////////////////////////////////////
void TxtStreamer::goToTheStreamStart()
{
	m_in.clear();
	m_in.seekg(0);
...
///////////////////////////////////////////////////////////////////////////////////////////
void TxtStreamer::RemoveCINFromFile()
{
...
///////////////////////////////////////////////////////////////////////////////////////////
int TxtStreamer::ReplyAmountOfDifferentArgs()
{
	return m_difObj;
}

///////////////////////////////////////////////////////////////////////////////////////////
std::map<char, int> TxtStreamer::ReplyParamInformation(int i_param)
{
	return m_map[i_param - 1];
}

///////////////////////////////////////////////////////////////////////////////////////////
void TxtStreamer::makeCinFileNames(std::string i_baseName)
{
...
///////////////////////////////////////////////////////////////////////////////////////////
bool TxtStreamer::readRule(std::string)
{
...
///////////////////////////////////////////////////////////////////////////////////////////
std::string TxtStreamer::convertTransactionString(std::string i_string)
{
	int param = 0;
